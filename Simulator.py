...
psi_A = gaussian_packet(X, Y, x0=0.3, y0=0.5, sigma=0.5, kx=26.0, ky=-38.0)  # moves right
psi_B = gaussian_packet(X, Y, x0=0.7, y0=0.5, sigma=0.5, kx=-40.0, ky=33.0) # moves left
...
# Initial plots
im1 = ax1.imshow(frames_array[0, 0], cmap=cmap, origin='lower', extent=[0, L, 0, L], vmin=0)
im2 = ax2.imshow(frames_array[0, 1], cmap=cmap, origin='lower', extent=[0, L, 0, L], vmin=0)
